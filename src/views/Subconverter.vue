...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "zhijianggeekstudio.com (自动编译最新版本后端-测试）": "https://zhijianggeekstudio.com/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://zhijianggeekstudio.com/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://zhijianggeekstudio.com/sub?";
